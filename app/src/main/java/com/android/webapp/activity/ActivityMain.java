...
public class ActivityMain extends AppCompatActivity {
    ...
    private void initComponent() {
        ...
        binding.mainWebView.getViewTreeObserver().addOnScrollChangedListener(new ViewTreeObserver.OnScrollChangedListener() {
            @Override
        ...
        // on swipe list
        binding.swipeRefreshLayout.setOnRefreshListener(() -> loadWebView(binding.mainWebView.getUrl()));
    }
