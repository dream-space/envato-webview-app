...
public class AppConfig {
    ...
    public static final String PULL_TO_REFRESH = "ENABLED";
    ...
    public static final boolean LOGS = BuildConfig.DEBUG;

    // development environment, value is set via build config in build.gradle
    public static final boolean DEV_ENVIRONMENT = BuildConfig.DEBUG;

    // AdMob test ads, value is set via build config in build.gradle
    public static final boolean TEST_ADS = BuildConfig.DEBUG;
}
